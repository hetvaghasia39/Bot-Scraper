// Purpose - This file acts as a mediator between the client side popup.js and the server side scrapy.
...
$decision=exec("/Library/Frameworks/Python.framework/Versions/3.10/bin/python3 scrapy crawl table_spider -a url=https://example.com
$site 2>&1 ");
echo $decision;
?>
